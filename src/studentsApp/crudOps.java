...
public class crudOps {
    ...
    public boolean saveRecord() {
        ...
        Connection conn = new dbConn().connector();
        try {
            pst = conn.prepareStatement("INSERT INTO student_details(student_id, first_name, last_name, gender, degree_program) VALUES (?,?,?,?,?)");
